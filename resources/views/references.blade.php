							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td>{{$data->ID}}</td>
											<td><img src="{{URL::asset($data->image)}}"></td>
											<td class="text-right">
												<a class="btn btn-outline-primary" href="{{route('dashboard.edit_reference', $data->ID)}}">Modifier</a>
												<a class="btn btn-outline-danger" href="{{route('dashboard.delete_reference', $data->ID)}}">Supprimer</a>
											</td>
										</tr>
										@endforeach
									</tbody>
